...
4. **Fail-Closed**: If the Lelu engine is unreachable or offline, tool execution is blocked by default.
...
cargo run
# Or via Docker
docker run -p 8088:8088 ghcr.io/lelu-ai/lelu:latest
```
