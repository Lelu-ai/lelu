    ...
    <div className="max-w-3xl">
      <div className="mb-10">
        ...
        <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
          Lelu offers official client SDKs for TypeScript, Python, and Go. These SDKs provide a
          type-safe, ergonomic way to interact with the Lelu Engine from agents and backend
          services.
        </p>
      </div>
      ...
      <div className="space-y-12">
        <section>
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mb-6">
            While you can call the REST API directly, the SDKs handle several complex tasks
            automatically:
          </p>
          <ul className="list-disc list-inside space-y-2 text-zinc-600 dark:text-zinc-400 mb-6 ml-2">
            <li>
              <strong>Long-polling:</strong> Automatically waits for human approval when a request
              is queued.
            </li>
            <li>
              <strong>Type Safety:</strong> Full TypeScript definitions and Python type hints.
            </li>
            <li>
              <strong>Retries:</strong> Built-in exponential backoff for network failures.
            </li>
            <li>
              <strong>Framework Integrations:</strong> Drop-in middleware for LangChain, AutoGPT,
              and Express.
            </li>
          </ul>
        </section>
          ...
          <div className="overflow-hidden rounded-xl border border-zinc-200 dark:border-white/10">
            <table className="w-full text-sm">
              <thead className="bg-zinc-50 dark:bg-zinc-900/50">
                <tr>
                  <th className="text-left px-4 py-3 text-zinc-700 dark:text-zinc-300 font-medium">
                    Method
                  </th>
                  <th className="text-left px-4 py-3 text-zinc-700 dark:text-zinc-300 font-medium">
                    Description
              ...
              <tbody className="divide-y divide-zinc-200 dark:divide-white/10">
                <tr>
                  ...
                  <td className="px-4 py-3 text-zinc-600 dark:text-zinc-400">
                    Human authorization via <span className="font-mono">/v1/authorize</span>
                  </td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-mono text-zinc-900 dark:text-zinc-100">
                  ...
                  <td className="px-4 py-3 text-zinc-600 dark:text-zinc-400">
                    Confidence-aware agent authorization via{" "}
                    <span className="font-mono">/v1/agent/authorize</span>
                  </td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-mono text-zinc-900 dark:text-zinc-100">
                  ...
                  <td className="px-4 py-3 text-zinc-600 dark:text-zinc-400">
                    Mint JIT token via <span className="font-mono">/v1/tokens/mint</span>
                  </td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-mono text-zinc-900 dark:text-zinc-100">
                  ...
                  <td className="px-4 py-3 text-zinc-600 dark:text-zinc-400">
                    Revoke token via <span className="font-mono">DELETE /v1/tokens/{"{id}"}</span>
                  </td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-mono text-zinc-900 dark:text-zinc-100">
                  ...
                  <td className="px-4 py-3 text-zinc-600 dark:text-zinc-400">
                    Engine health check via <span className="font-mono">/healthz</span>
                  </td>
                </tr>
              </tbody>
            </table>
