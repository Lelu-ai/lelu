    ...
    <div className="flex flex-col lg:flex-row h-screen overflow-hidden">
      ...
      <div className="lg:w-[420px] xl:w-[480px] shrink-0 bg-[#0A0A0A] flex flex-col px-8 py-10 lg:py-12 overflow-hidden">
        ...
        <div className="mt-6 lg:mt-auto pt-8 border-t border-white/10 flex items-center gap-4 text-[12px] text-white/40 flex-wrap">
          <a href="https://github.com/lelu-ai/lelu" target="_blank" rel="noreferrer" className="hover:text-white/70 transition-colors">Community</a>
          ...
          <div className="ml-auto flex items-center gap-3 text-white/30">
            ...
            <a href="https://github.com/lelu-ai/lelu" target="_blank" rel="noreferrer" className="hover:text-white/70 transition-colors" aria-label="GitHub">
        ...
        <div className="flex-1 px-6 sm:px-10 py-10 max-w-[800px]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-[13px]">
            {[
              ...
              { label: "About", href: "/about" },
              { label: "GitHub", href: "https://github.com/lelu-ai/lelu" },
            ].map((l) => (
              <Link
                key={l.href}
                href={l.href}
