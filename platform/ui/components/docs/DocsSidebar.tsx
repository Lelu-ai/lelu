...
export function DocsSidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-[240px] shrink-0 sticky top-14 h-[calc(100vh-56px)] border-r border-[#E7E5E4] dark:border-[#27272A] bg-white dark:bg-[#0A0B10]">
      {/* Scrollable nav area */}
      <div
        ref={scrollRef}
      ...
      >
        {/* Version selector */}
        <button className="w-full mb-3 flex items-center gap-2 px-3 py-2 text-xs border border-[#E7E5E4] dark:border-[#27272A] rounded-md bg-white dark:bg-[#0A0B10] hover:bg-[#F5F5F4] dark:hover:bg-[#0D0E13] transition-colors text-left">
          <svg
            width="12"
            height="12"
            viewBox="0 0 24 24"
        ...
        {/* Search */}
        <button className="w-full mb-5 flex items-center gap-2 px-3 py-2 text-xs text-[#737373] hover:text-[#0A0A0A] dark:hover:text-white bg-[#F5F5F4] dark:bg-[#0D0E13] border border-[#E7E5E4] dark:border-[#27272A] rounded-md transition-colors">
          <svg
            width="13"
            height="13"
            viewBox="0 0 24 24"
          ...
          <kbd className="flex items-center px-1.5 py-0.5 text-[10px] font-medium text-[#737373] bg-white dark:bg-[#0A0B10] border border-[#E7E5E4] dark:border-[#27272A] rounded">
            ⌘K
          </kbd>
        </button>
      ...
      <div className="px-4 pt-3 pb-1">
        <a
          ...
          className="flex items-center justify-center gap-1.5 w-full px-3 py-2 rounded-lg border border-[#E7E5E4] dark:border-[#27272A] text-[12px] font-semibold text-[#0A0A0A] dark:text-white hover:bg-[#F5F5F4] dark:hover:bg-[#0D0E13] transition-colors"
        >
